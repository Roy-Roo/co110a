...
CHIP CPU {
    ...
    Mux16(a = instruction, b = back, sel = isC, out = if1);
    ...
    DRegister(in = back, load = Dload, out = Dout);

    ALU(x = Dout, y = if2, zx = c1, nx = c2, zy = c3, ny = c4, f = c5, no = c6, out = back, out = outM, zr = zr, ng = ng);

    Or(a =ng, b = zr, out = ngzr);
    And(a = ng, b = j1, out = passL);
    And(a = zr, b = j2, out = passE);
    And(a = gt, b = j3, out = passG);
    Or(a = passL, b = passE, out = passLE);
    Or(a = passLE, b = passG, out = pass);
